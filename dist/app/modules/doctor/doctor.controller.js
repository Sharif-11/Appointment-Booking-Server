...
const createDoctorController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield doctor_service_1.doctorServices
        ...
        .catch(err => {
        res.status(500).json({ status: false, message: err === null || err === void 0 ? void 0 : err.message });
    });
});
const updateDoctorController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { phoneNo } = req.decoded;
        const data = yield doctor_service_1.doctorServices.updateDoctorService(phoneNo, req.body);
        res.status(200).json({
            status: true,
