...
const createAppointmentController = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const appointment =
        yield appointment_service_1.appointmentServices.createAppointment(
          slotId,
        )
      res.status(200).send({
        status: true,
...
const startAppointmentController = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params
...
const closeAppointmentController = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params
      const data =
        yield appointment_service_1.appointmentServices.closeAppointment(id)
      res.status(200).json({
        status: true,
...
const deleteAppointmentController = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params
      const data =
        yield appointment_service_1.appointmentServices.deleteAppoinment(id)
      res.status(200).json({
        status: true,
...
const getAppointmentsController = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const result =
        yield appointment_service_1.appointmentServices.getAppointments()
      res.status(200).json({
        status: true,
...
const getUpcomingAppointmentsController = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { date } = req.body
      const result =
        yield appointment_service_1.appointmentServices.getUpcomingAppointment(
          date,
        )
      res.status(200).json({
        status: 200,
