...
userRoutes.post(
  '/doctor',
  user_validator_1.userValidator.validateDoctor,
  doctor_controller_1.doctorControllers.createDoctorController,
)
userRoutes.post(
  '/patient',
  user_validator_1.userValidator.validatePatient,
  patient_controller_1.patientControllers.createPatientController,
)
userRoutes.post(
  '/login',
  user_validator_1.userValidator.validateLogin,
  user_controller_1.userControllers.loginController,
)
...
userRoutes.patch(
  ...
  user_controller_1.userControllers.updatePasswordController,
)
