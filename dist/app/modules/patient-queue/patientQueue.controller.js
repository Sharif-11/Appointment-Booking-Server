...
const updateServiceStatusController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { bookingId } = req.params;
        const data = yield patientQueue_service_1.patientQueueServices.updateServiceStatus(bookingId);
        res.status(200).json({
            status: true,
...
exports.patientQueueControllers = {
