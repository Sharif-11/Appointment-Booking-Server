...
const createBooking = (appointmentId, patientId, problemDescription) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const appointmentDay = doctor_constant_1.daysOfWeek[new Date(appointment.date).getDay()];
    if (today !== appointmentDay ||
        appointment.status !== 'pending' ||
        appointment.remainingSlots <= 0) {
        throw new Error(`You can't book a slot for this appointment`);
    }
    const existedBooking = yield booking_model_1.default.findOne({ patientId, appointmentId });
    if (existedBooking) {
    ...
    try {
        ...
        const updatedAppointment = yield appointment_model_1.default.findByIdAndUpdate(appointment._id.toString(), {
            $inc: {
                remainingSlots: -1,
            },
...
const checkBooking = (appointmentId, phoneNo) => __awaiter(void 0, void 0, void 0, function* () {
