...
const createPatientService = userData =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const newPatient = yield patient_model_1.default.create([patient], {
        session,
      })
...
const updatePatientProfile = (phoneNo, updateObj) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.default.findOne({ phoneNo })
    const updatedPatient = yield patient_model_1.default.findByIdAndUpdate(
...
const getPatientProfile = phoneNo =>
  __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.default.findOne({ phoneNo })
    const result = yield patient_model_1.default.findById(
      user === null || user === void 0 ? void 0 : user.userId,
    )
    return result
  })
