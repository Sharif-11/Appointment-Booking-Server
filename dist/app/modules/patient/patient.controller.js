...
const updatedPatientController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { phoneNo } = req.decoded;
        const data = yield patient_service_1.patientServices.updatePatientProfile(phoneNo, req.body);
        res.status(200).json({
            status: true,
...
const getPatientProfileController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { phoneNo } = req.decoded;
        const data = yield patient_service_1.patientServices.getPatientProfile(phoneNo);
        res.status(200).json({
            status: true,
...
const getDoctorProfileController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
